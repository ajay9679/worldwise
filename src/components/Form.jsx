...
function Form(){
    ...
    async function handleSubmit(e){
        ...
        const newCity = {cityName,date,notes,emoji,country,position:{lat:Number(lat),lng:Number(lng)},id:uuidv4()};
        // console.log(newCity)
    ...
    return <form className={`${styles.form} ${isLoading ? styles.loading : ''}`} onSubmit={handleSubmit} >
